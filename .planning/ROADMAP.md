...
- [x] **Phase 10: ES Query DSL Builder** - Deliver a pipe-based composable ES query builder and optional generated `ES.Queries` module per projection (completed 2026-06-25)
- [x] **Phase 11: MCP Generator and Introspection** - Add `gen_es_projection` tool and surface ES projections in `domain_map` and `ListProjections` (completed 2026-06-25)
...
- [x] 06-02-PLAN.md — ES/OpenSearch storage adapter (write/4, reset/2, engine detection, index management)
...
**Plans:** 2/2 plans complete
Plans:
- [x] 07-01-PLAN.md — ES commit path implementation (GenServer state, live write, bulk flush, OTel, telemetry)
- [x] 07-02-PLAN.md — ES GenServer integration tests (BULK-01, BULK-02, BULK-03, OBSV-01, OBSV-02)
...
Plans:
- [x] 08-01-PLAN.md — ES macro DSL (project_es/2, __dispatch_es__/3, child_spec ES branch, GenServer :init_adapter)
...
- [x] 10-02-PLAN.md — gen_es_queries/2 generator, GenEsQueries MCP tool, and server registration
...
**Plans:** 2/2 plans complete
Plans:
- [x] 11-01-PLAN.md — gen_es_projection generator function, MCP tool, and server registration (MCP-01)
...
| 11. MCP Generator and Introspection | v1.1 | 2/2 | Complete   | 2026-06-25 |
