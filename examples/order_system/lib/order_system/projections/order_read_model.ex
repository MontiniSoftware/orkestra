defmodule OrderSystem.Projections.OrderReadModel do
  ...
  def changeset(order, attrs) do
    order
    |> cast(attrs, [:id, :product_name, :quantity, :price, :total, :customer_email, :status, :cancelled_at, :cancel_reason])
    |> validate_required([:id, :product_name, :quantity, :price, :total, :customer_email, :status])
  end
end
